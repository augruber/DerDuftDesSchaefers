...
\begin{minipage}{\linewidth}
\centering
Luis Fonsi and Daddy Yankee \textbf{«Despacito»}

\includegraphics[width=1.18363in,height=1.18363in,alt={Ein Bild, das Muster, Grafiken enthält. KI-generierte Inhalte können fehlerhaft sein.}]{media/QR-Code-Datum_26-12-2025_Zeit_15-25-20/008_Despasito_Luis_Fonsi,_Daddy_Yankee_Spotify.png}
\end{minipage}
\vspace{0.8\baselineskip}
\end{center}
