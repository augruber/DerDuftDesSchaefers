...
\paragraph{Mailand (IT), Sonntag, 19.
...
\paragraph{\texorpdfstring{«\emph{Roccia del Culto}», Mailand (IT)
...
\paragraph{Montag, 20. August}\label{montag-20.-august}
...
\paragraph{Mailand (IT), Montag, 20.
...
\paragraph{Montag, 20. August}\label{montag-20.-august-1}
...
\paragraph{Tessin (CH)}\label{tessin-ch}
...
\paragraph{Zürich (CH)}\label{zuxfcrich-ch}
...
\paragraph{Dienstag, 21. August}\label{dienstag-21.-august}
...
\paragraph{Donnerstag, 23. August}\label{donnerstag-23.-august}
...
\paragraph{Zürich (CH), Freitag, 24.
...
\paragraph{Urdorf (CH), Samstag, 25.
...
\paragraph{Zürich (CH), Samstag, 25.
...
\paragraph{Bettmeralp/VS (CH)}\label{bettmeralpvs-ch}
...
\paragraph{Samstag, 25. August}\label{samstag-25.-august}
...
\paragraph{\texorpdfstring{«\emph{Sunnewaid}», Bettmeralp/VS
...
\paragraph{Sonntag, 26. August}\label{sonntag-26.-august}
...
\paragraph{Montag, 27. August}\label{montag-27.-august}
...
\subsection{41}\label{section-40}
...
\subsection{42}\label{section-41}
...
\paragraph{«Roccia del Culto», Mailand (IT), Montag, 20.
...
\subsection{44}\label{section-43}
...
\section{\texorpdfstring{Der diensthabende Arzt auf der Notfallstation
...
\subsection{\texorpdfstring{«Nein, leider nicht. Kein Handy, keine
...
\subsection{Mantovani sprach gereizt. Er hatte kaum geschlafen. Bereits
...
\subsection{«Ja, exakt, alle Vermisstenmeldungen,» seine Stimme bekam
...
\subsection{«Und, Melik, suche bitte den Platz oben am Felsen akribisch
nach möglichen Spuren
ab.»}\label{und-melik-suche-bitte-den-platz-oben-am-felsen-akribisch-nach-muxf6glichen-spuren-ab.}

\subsection{Mantovani hörte kurz zu.}\label{mantovani-huxf6rte-kurz-zu.}

\subsection{«Hm, ja, genau da. Nimm Rossi
mit.»}\label{hm-ja-genau-da.-nimm-rossi-mit.}

\subsection{\texorpdfstring{Als der Arzt vor ihm stand, verabschiedete
er sich.
}{Als der Arzt vor ihm stand, verabschiedete er sich. }}\label{als-der-arzt-vor-ihm-stand-verabschiedete-er-sich.}

\subsection{«Ciao, Melik, danke, ich bin gegen 10:00 Uhr in der Quästur,
bis
...
\subsection{46}\label{section-46}

\paragraph{Dienstag, 21. August}\label{dienstag-21.-august-1}
...
\subsection{47}\label{section-47}

\paragraph{Bettmeralp/VS (CH), Montag, 27.
...
\subsection{48}\label{section-48}

\paragraph{Dienstag, 28. August}\label{dienstag-28.-august}
...
\subsection{49}\label{section-49}

\paragraph{Auf der Alp, Bettmeralp/VS (CH), Mittwoch, 29.
...
\subsection{50}\label{section-50}
...
\subsection{51}\label{section-51}
...
\subsection{52}\label{section-52}
...
\subsection{53}\label{section-53}

\paragraph{Donnerstag, 30. August}\label{donnerstag-30.-august}
...
\subsection{54}\label{section-54}
...
\subsection{55}\label{section-55}
...
\subsection{56}\label{section-56}
...
\subsection{57}\label{section-57}

\paragraph{Mailand (IT), Mittwoch, 22.
...
\subsection{58}\label{section-58}
...
\subsection{59}\label{section-59}

\paragraph{Freitag, 31. August}\label{freitag-31.-august}
...
\subsection{60}\label{section-60}
...
\subsection{61}\label{section-61}
...
\subsection{62}\label{section-62}

\paragraph{Auf der Alp, Bettmeralp/VS (CH), Freitag, 31.
...
\subsection{63}\label{section-63}
...
\subsection{64}\label{section-64}
...
\subsection{65}\label{section-65}
...
\subsection{66}\label{section-66}

\paragraph{Samstag, 1. September}\label{samstag-1.-september}
...
\subsection{67}\label{section-67}

\paragraph{Sonntag, 2. September}\label{sonntag-2.-september}
...
\subsection{68}\label{section-68}

\paragraph{Bettmeralp/VS (CH), Montag, 3.
...
\subsection{69}\label{section-69}
...
\subsection{70}\label{section-70}
...
\subsection{71}\label{section-71}
...
\subsection{72}\label{section-72}
...
\subsection{73}\label{section-73}
...
\subsection{74}\label{section-74}

\paragraph{Dienstag, 4. September}\label{dienstag-4.-september}
...
\subsection{75}\label{section-75}

\paragraph{Auf der Alp, Bettmeralp/VS (CH), Mittwoch, 5.
...
\subsection{76}\label{section-76}
...
\subsection{77}\label{section-77}
...
\subsection{78}\label{section-78}

\paragraph{Bettmeralp/VS (CH), Donnerstag, 6.
...
\subsection{79}\label{section-79}

\paragraph{Freitag, 7. September}\label{freitag-7.-september}
...
\subsection{80}\label{section-80}
...
\subsection{81}\label{section-81}
...
\subsection{82}\label{section-82}

\paragraph{Freitag, 7. September}\label{freitag-7.-september-1}
...
\subsection{83}\label{section-83}

\paragraph{Mailand (IT), Mittwoch, 5.
...
\subsection{84}\label{section-84}

\paragraph{Bettmeralp/VS (CH), Freitag, 7.
...
\subsection{85}\label{section-85}

\paragraph{Samstag, 8. September}\label{samstag-8.-september}
...
\subsection{86}\label{section-86}
...
\subsection{87}\label{section-87}
...
\section{\texorpdfstring{Teil II }{Teil II }}\label{teil-ii}

\subsection{88}\label{section-88}

\paragraph{Bettmeralp/VS (CH), Samstag, 8.
...
\subsection{89}\label{section-89}

\paragraph{\texorpdfstring{Mailand (IT), Sonntag, 9. September
...
\subsection{90}\label{section-90}

\paragraph{Bettmeralp/VS (CH), Sonntag, 9.
...
\subsection{91}\label{section-91}

\paragraph{Mailand (IT), Montag, 10.
...
\section{\texorpdfstring{Teil III }{Teil III }}\label{teil-iii}

\subsection{92}\label{section-92}

\paragraph{Bettmeralp/VS (CH), Montag, 10.
...
\subsection{93}\label{section-93}
...
\subsection{94}\label{section-94}

\paragraph{Bettmeralp/VS (CH), Dienstag, 11.
...
\subsection{95}\label{section-95}

\paragraph{Mailand (IT), Dienstag, 11.
...
\subsection{96}\label{section-96}
...
\subsection{97}\label{section-97}

\paragraph{Bettmeralp/VS (CH), Mittwoch, 12.
...
\subsection{98}\label{section-98}
...
\subsection{99}\label{section-99}
...
\subsection{100}\label{section-100}

\paragraph{Mailand (IT), Mittwoch, 12.
...
\subsection{101}\label{section-101}

\paragraph{Mailand (IT), Donnerstag, 13.
...
\subsection{102}\label{section-102}
...
\subsection{103}\label{section-103}

\paragraph{Bettmeralp/VS (CH), Donnerstag, 13.
...
\subsection{104}\label{section-104}

\paragraph{Mailand (IT), Samstag, 15.
...
\subsection{105}\label{section-105}
...
\subsection{106}\label{section-106}
...
\subsection{107}\label{section-107}

\paragraph{Bettmeralp/VS (CH), Dienstag, 18.
...
\section{Teil IV}\label{teil-iv}

\subsection{108}\label{section-108}

\paragraph{Bettmeralp/VS (CH), im
...
\subsection{109}\label{section-109}
...
\subsection{110}\label{section-110}
...
\subsection{111}\label{section-111}
...
\subsection{112}\label{section-112}

\paragraph{Bettmeralp/VS (CH), Anfang
...
\subsection{113}\label{section-113}
...
\subsection{114}\label{section-114}

\paragraph{Mailand (IT), im November}\label{mailand-it-im-november}
...
\subsection{115}\label{section-115}
...
\subsection{116}\label{section-116}
...
\subsection{117}\label{section-117}
...
\subsection{118}\label{section-118}
...
\subsection{119}\label{section-119}

\paragraph{Nervi, Genua (IT), im
...
\subsection{120}\label{section-120}
...
\subsection{121}\label{section-121}
...
\subsection{Urheberrechte Text
klären!}\label{urheberrechte-text-kluxe4ren}

\subsection{\texorpdfstring{«MOVING ON»
...
\subsection{122}\label{section-122}
